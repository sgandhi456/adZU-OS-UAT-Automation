...
WebUI.click(findTestObject('Assets/Page_Samsung Marketing Cloud/Page_Samsung Marketing Cloud/a_Download'))

WebUI.click(findTestObject('Assets/Page_Samsung Marketing Cloud/Page_Samsung Marketing Cloud/div_ActionDropdown'))

WebUI.click(findTestObject('Assets/Page_Samsung Marketing Cloud/Page_Samsung Marketing Cloud/a_Share'))

WebUI.click(findTestObject('Assets/Page_Samsung Marketing Cloud/Page_Samsung Marketing Cloud/ul_selectuseremail'))

WebUI.click(findTestObject('Assets/Page_Samsung Marketing Cloud/Page_Samsung Marketing Cloud/div_SearchingEmail'))

WebUI.click(findTestObject('Assets/Page_Samsung Marketing Cloud/Page_Samsung Marketing Cloud/div_Kirithan Kandasamy  (kkirithanhotmailcom)'))
