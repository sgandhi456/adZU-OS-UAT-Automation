...
WebUI.click(findTestObject('Assets/Edit Asset/Page_Samsung Marketing Cloud/Edit_Asset_Name'))

WebUI.delay(1)

WebUI.setText(findTestObject('Assets/Edit Asset/Page_Samsung Marketing Cloud/Edit_Asset_Name'), name)
